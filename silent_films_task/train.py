...
#optional, you can choose to do not use the data augmentation.
df_train = df_trainsetdavideo(df_train)   # only augmentation the trian set
print(len(df_train))
...
with open(fileName,'a+')as file:
    file.write("withC3D\nseed:"+str(seed)+"  batchsize:"+str(batch_size)+"  epoch:"+str(epoch)+"  testacc:"+str(test_accuracy)+"\n")

#case study
case_study = '/data/yanyuliang/IJCAI2023/Data/case_study/sf.xlsx'
data = pd.read_excel(case_study)
X_qr = data.Question.values + data.Answer.values
inputs_qr, masks_qr = preprocessing_for_bert(X_qr)
inputs_qr = inputs_qr.to(device_ids[0])
masks_qr = masks_qr.to(device_ids[0])

f1 = get_frames("/data/yanyuliang/IJCAI2023/Data/video_raw/Clip1.mp4")
img1 = transform_frames(f1)
img2 = img1
f3 = get_frames("/data/yanyuliang/IJCAI2023/Data/video_raw/Clip2.mp4")
img3 = transform_frames(f3)
f4 = get_frames("/data/yanyuliang/IJCAI2023/Data/video_raw/Clip3.mp4")
img4 = transform_frames(f4)
f5 = get_frames("/data/yanyuliang/IJCAI2023/Data/video_raw/Clip4.mp4")
img5 = transform_frames(f5)
f6 = get_frames("/data/yanyuliang/IJCAI2023/Data/video_raw/Clip5.mp4")
img6 = transform_frames(f6)
t1 = torch.stack([img1, img2, img3, img4, img5, img6], dim=0)
t2 = torch.stack([img1, img2, img3, img4, img5, img6], dim=0)
t = torch.cat([t1, t2],dim=0)
t = t.to(device_ids[0])

results = v_duma_classifier(inputs_qr, masks_qr, t)
